...
class ToDoList:
    def __init__(self, root):
        ...
        self.task_entry.config(state="normal")  # Make the entry field editable
        self.task_entry.focus_set()  # Set focus on the entry field

        # Create buttons frame
        self.buttons_frame = tk.Frame(self.task_entry_frame)
        ...
        self.add_task_button.pack(fill="x", side="top")

        # Create delete task button
        self.delete_task_button = tk.Button(self.buttons_frame, text="Delete Task", command=self.delete_task)
        self.delete_task_button.pack(fill="x", side="top")

        # Create update task button
        self.update_task_button = tk.Button(self.buttons_frame, text="Update Task", command=self.update_task)
        self.update_task_button.pack(fill="x", side="top")
